...
- полностью реализовано всплывающее окно с регулированием яркости, слайдер из него вынесен в отдельный реюзабельный компонент, слайдер реагирует на мышку и тачскрин, а также имеет свой API, через который можно устанавливать или забирать его значение
